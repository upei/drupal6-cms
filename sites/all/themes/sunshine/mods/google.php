<?php 
	$bucket = _get_bucket(); 
	if($bucket == "home" || $bucket == "avc"){$searchstyle="padding-right:15px;width:976px;background-image:url(/home/sites/all/themes/sunshine/images/market/". $bucket ."/bkgrd_search.gif);";}else{$searchstyle="width:1000px;";}
?>
<div align="center">
