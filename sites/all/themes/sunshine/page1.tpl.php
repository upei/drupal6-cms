...
<head>
  <title><?php print "University of Prince Edward Island - UPEI" //$head_title ?></title>
...
<?
	...
	if($aURI[1] == "home" && !$aURI[2]){$DisplayTitle = "<a style=\"text-decoration:underline;\" href=\"http://www.upei.ca/news\">". $title ."</a>";}else{$DisplayTitle = $title;}
?>		  
