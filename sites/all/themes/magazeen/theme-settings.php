<?php
// $Id: theme-settings.php,v 1.6.2.2 2009/05/04 07:31:23 zinv Exp $
...
function phptemplate_settings($saved_settings) {
  ...
  // Search Input Text
  $form['tnt_container']['general_settings']['search_container']['search_input'] = array(
    '#type' => 'fieldset',
    '#title' => t('Search Input Text'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['tnt_container']['general_settings']['search_container']['search_input']['search_text'] = array(
    '#type' => 'textfield',
    '#title' => t('Search Input Text'),
    '#description' => t('Customize the text for the search input.'),
    '#size' => 60,
    '#default_value' => $settings['search_text'],
  );

  // Search Result
  $form['tnt_container']['general_settings']['search_container']['search_results'] = array(
    '#type' => 'fieldset',
  ...
  // Comment Setting
  $form['tnt_container']['general_settings']['comment_container'] = array(
    '#type' => 'fieldset',
  ...
  // Comment Title
  $form['tnt_container']['general_settings']['comment_container']['comment_title'] = array(
    '#type' => 'textfield',
  ...
  // No Comment Message
  $form['tnt_container']['general_settings']['comment_container']['no_comment_message'] = array(
    '#type' => 'textfield',
    '#title' => t('No Comment Message'),
    '#description' => t('Display a message if there no comment. HTML is allowed.'),
    '#size' => 71,
    '#default_value' => $settings['no_comment_message'],
  );
